  ...
  return (
    <section id="mission" className="py-20 md:py-28 bg-[#F8FAFC] border-t border-[#CBD5E1] scroll-mt-20">
      <SectionContainer>
        ...
        <StaggerReveal stagger={0.1} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-[#CBD5E1] border border-[#CBD5E1] rounded-[4px] overflow-hidden">
          {audiences.map((item) => (
            <StaggerItem key={item.cohortNumber} animation="fade-up">
              <div className="flex flex-col justify-between p-8 bg-white hover:bg-[#F8FAFC] transition-colors h-full">
                <div>

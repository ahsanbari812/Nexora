      ...
      <SectionContainer>
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <ScrollReveal animation="fade-up" delay={0.35}>
            <StaggerReveal stagger={0.08} className="pt-8 border-t border-white/10 w-full grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs font-mono text-[#CBD5E1]">
              {assurances.map((item, idx) => (
                <StaggerItem key={idx} animation="fade-up">
                  <div className="flex items-center justify-center gap-2 p-2 rounded-[2px] bg-white/[0.02] border border-white/5">
